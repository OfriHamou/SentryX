...
const JETSON_BASE_URL =
  process.env.JETSON_BASE_URL || "http://sentryx-jetson:5000";

// Jetson video bridge
const JETSON_VIDEO_URL =
  process.env.JETSON_VIDEO_URL || "http://sentryx-jetson:5001";

// Jetson detection bridge
const JETSON_DETECTION_URL =
  process.env.JETSON_DETECTION_URL || "http://sentryx-jetson:5002";
